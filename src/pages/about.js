        ...
        <ContentLayout>
          <div className='contactHolder'>
            ...
            <h3 style={{ fontSize: '1.4rem' }} className='aboutHolder'>
              After my studies in Innsbruck at the Medienkolleg and the MCI, I recently finished my
              Master's Degree in Interactive Media at the University of Applied Sciences Upper
              Austria.
            </h3>
            <h3 style={{ fontSize: '1.4rem' }} className='aboutHolder'>
